...
public class playercontroller2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        kadran = GameObject.FindWithTag("kadrantag2").gameObject;
        hiztxt = GameObject.FindWithTag("kphtag2").GetComponent<Text>();
        vitestxt = GameObject.FindWithTag("vitestag2").GetComponent<Text>();
        tersyon = GameObject.FindWithTag("tersyontag2").gameObject;
    ...
    private void carcontroller()
    {
        ...
        float yatay = Input.GetAxis("yatay");
        float dikey = Input.GetAxis("dikey");
        if (hiz < max_hiz)
        {
